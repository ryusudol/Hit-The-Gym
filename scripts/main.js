...
const mainBannerBGImg = document.getElementById("main-banner-bgimg");
/* Information Variables */
const informationBGImg = document.getElementById("inform-bgimg");

/* Numbers */
const mainBannerImgNum = 33;
const workoutImgNum = 40;
...
// Random Background Img Generating in Welcome Section
const imgNum = Math.floor(Math.random() * mainBannerImgNum);
mainBannerBGImg.src = `./assets/welcome-images/${imgNum}.jpg`;

// Random Background Img Generating in Routine Maker Section
const imgNum2 = Math.floor(Math.random() * workoutImgNum);
informationBGImg.src = `./assets/workout-images/${imgNum2}.jpg`;
